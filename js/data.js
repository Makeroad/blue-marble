...
const gameConfig = {
  bluemarble: {
    name: '부루마블',
    startMoney: 2940000,   // ルールブック基準: 294万ウォン
    salaryOnPass: 200000,
    maxConsecutiveDoubles: Infinity,
    jailName: '무인도',    // 교도소 → 무인도に名称変更
    islandName: '무인도',
...
const ruleBook = {
  bluemarble: {
    ...
    sections: [
      ...
      {
        title: '⚡ 특수 규칙',
        content: '• 무인도: 더블 굴리기(최대 3턴) 또는 ₩20,000 납부(다음 턴 이동)\n  3턴 경과 시 4번째 턴에 자동 탈출(강제 이동)\n• 공항: 소유자 있을 때 통과 시 통행료 납부\n• 찬스 카드: 랜덤 이벤트 발생\n• 전력회사/수도세: 소유자 있을 때 주사위 합×4 납부',
      },
    ],
  },
  monopoly: {
